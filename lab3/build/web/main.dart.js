...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  main.MyApp = class MyApp extends framework.StatelessWidget {
    ...
    build(context) {
      return new app.MaterialApp.new({title: "Инкремент", theme: theme_data.ThemeData.new({colorSchemeSeed: colors.Colors.purple, useMaterial3: true, brightness: ui.Brightness.light}), darkTheme: theme_data.ThemeData.new({colorSchemeSeed: colors.Colors.green, useMaterial3: true, brightness: ui.Brightness.dark}), home: C[1] || CT.C1, debugShowCheckedModeBanner: false});
    }
  };
  ...
  main._MyHomePageState = class _MyHomePageState extends framework.State$(main.MyHomePage) {
    ...
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: new text.Text.new(this.widget.title)}), body: new basic.Center.new({child: new basic.Column.new({mainAxisAlignment: flex.MainAxisAlignment.center, children: T.JSArrayOfWidget().of([C[2] || CT.C2, new text.Text.new(dart.str(this[_counter]), {style: theme.Theme.of(context).textTheme.headlineMedium}), C[3] || CT.C3, new basic.Row.new({mainAxisAlignment: flex.MainAxisAlignment.center, children: T.JSArrayOfWidget().of([new floating_action_button.FloatingActionButton.new({onPressed: dart.bind(this, _decrementCounter), tooltip: "Decrement", child: C[4] || CT.C4, backgroundColor: colors.Colors.blue}), new floating_action_button.FloatingActionButton.new({onPressed: dart.bind(this, _incrementCounter), tooltip: "Increment", child: C[6] || CT.C6})])}), C[3] || CT.C3, new text_button.TextButton.new({onPressed: dart.bind(this, _removeButton), child: C[8] || CT.C8})])})})});
    }
  ...
  }, '{"version":3,"sourceRoot":"","sources":["/zapp/project/.zapp_entry.dart","/zapp/project/lib/main.dart","/zapp/project/.dart_tool/dartpad/web_plugin_registrant.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA2CI,IA1BF,iCAAgB;AACd,UAAoB,6BAGD;AAF8B,QAA9B,AAAkB,6BAElB,eAF2B;;AAEL,QAAF,CAApB;;AAEnB,UAAO,AAAQ,uBAAY;AAKvB,QAJK,AAAqC,qBAA7B,qCAAuB,uBAAW,QAAC;AAG9C,UAFC,AAAQ,sBAAW,2BAA2B,CAC/C;;;wBAIL,SAAC,GAAG;AACL,UAAO,AAAQ,uBAAY;AAIvB,QAHC,AAAQ,sBAAW,wBAAwB,CAC5C,AAAE,CAAD,eACD,AAAW,UAAD;;2DAGM,yCACb,SAAC,MAAM,QAAQ,MAAM;AAC1B,cAAO,AAAQ,uBAAY;AAC4B,YAAlD,AAAQ,sBAAW,wBAAwB,CAAC,IAAI;;;EAI3D;;AAEiB;AAQd,MAPD,MAAS,gCACC;AACS,UAAf;6CAEe;AACmB,UAAjB;;IAGvB;;;;;;;;;UC5C4B;AACxB,YAAO,iCACE,oBACA,2CACmB,oCACV,kBACS,kCAEd,2CACe,mCACV,kBACS,uEAGG;IAEhC;;;QApBmB;AAAb,8CAAa,GAAG;;EAAE;;;;;;;;;;IAmCX;;;;;;;;;;;;AAGsB;IAAkB;;;QAd7B;QAAmB;;AAArC,mDAAkB,GAAG;;EAAuB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAwB9C,MAHF,cAAS;AAEG,QAAV,iBAAA,AAAQ,iBAAA;;IAEZ;;AAMI,MAHF,cAAS;AAEG,QAAV,iBAAA,AAAQ,iBAAA;;IAEZ;;AAMI,MAHF,cAAS;AAEG,QAAV,iBAAS;;IAEb;UAG0B;AAOxB,YAAO,oCACG,+BAGC,kBAAK,AAAO,4BAEf,6BAGG,yCAegC,yCACnB,uCAIhB,kBACa,SAAT,yBACW,AAAY,AAAU,eAAnB,OAAO,6CAGzB,sCACuC,yCACnB,wBAChB,0EACa,mCACF,oDAEe,sBAE9B,0EACO,mCACF,wDAML,qDACa;IAQvB;;;;;;IA3FI,iBAAW;;;EA4FjB;;;;;;;;;;;;;;;;AA1IuB,IAArB;EACF;;ECGwB","file":"main.js"}');
  // Exports:
  return {
